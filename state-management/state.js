export const states = {
  // index defining the state in Player's states array
  STANDING_LEFT: 0,
  STANDING_RIGHT: 1,
  SITTING_LEFT: 2,
  SITTING_RIGHT: 3,
...
export class StandingLeft extends State {
  ...
  enter() {
    this.player.frameY = 1; // to set up sprite sheet's rows
    this.player.speed = 0;
    this.player.maxFrame = 6;
  }
  handleInput(input) {
    // to set current player state
    // it's ignoring all keys and just reacting whith the pressed key defined bellow
